...
const ShowImage = ({
  ...
  useEffect(() => {
    formik ? formik.setFieldValue("image", image) : null;
  }, [image]);

  return (
    <label className="block">
      <div
        className={`bg-gray-200 ${width60 && "w-60 h-60"} ${
          width40 && "w-40 h-40"
      ...
      >
        {image ? (
          <>
            <img
              className={`rounded-full ${width60 && "w-60 h-60"} ${
                width40 && "w-40 h-40"
              }`}
